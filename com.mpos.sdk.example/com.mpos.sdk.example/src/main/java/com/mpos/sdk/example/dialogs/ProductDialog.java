...
public class ProductDialog extends Dialog implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    public void onClick(View view) {
        if (view instanceof ImageView) {
            ...
            if (view.getId() == R.id.product_btn_ok) {
                if (isValid())
                    dismiss();
                else
                    Toast.makeText(getContext(), getValidReport(), Toast.LENGTH_LONG).show();
            }
            else if (view.getId() == R.id.product_btn_cancel) {
                cancel();
            }
            else if (view.getId() == R.id.product_btn_prepare) {
